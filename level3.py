...
class Game3(object):
    def __init__(self):
        ...
        self.enemies.add(Slime1(451, 357, ES, 0))
        self.enemies.add(Slime1(675, 357, 0, -ES))
        self.enemies.add(Slime2(547, 451, -ES, 0))
        self.enemies.add(Slime2(35, 357, 0, ES))
        self.enemies.add(Slime2(163, 131, ES, 0))
    ...
    def display_frame(self, screen):
        ...
        text2 = self.font2.render("Points X4", True, WHITE)
        ...
        if self.game_over:
            ...
            text2 = self.font.render("Level 3", True, RED)
