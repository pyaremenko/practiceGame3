...
class Game5(object):
    def __init__(self):
        ...
        self.enemies.add(Slime4(547, 451, ES, 0))
        self.enemies.add(Slime1(451, 355, ES, 0))
        self.enemies.add(Slime1(675, 355, 0, -ES))
        self.enemies.add(Slime3(547, 451, -ES, 0))
        self.enemies.add(Slime2(35, 357, 0, ES))
        self.enemies.add(Slime3(163, 131, ES, 0))
        self.enemies.add(Slime3(451, 227, -ES, 0))
        self.enemies.add(Slime4(163, 355, ES, 0))
        self.enemies.add(Slime4(35, 227, 0, ES))
        for i, row in enumerate(enviroment()):
            for j, item in enumerate(row):
                if item == 1:
    ...
    def display_frame(self, screen):
        ...
        text2 = self.font2.render("Points X10", True, WHITE)
        ...
        if self.game_over:
            ...
            text2 = self.font.render("Level 5", True, RED)
